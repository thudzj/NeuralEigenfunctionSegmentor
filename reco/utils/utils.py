...
def get_dataset(
    ...
    if dataset_name == "cityscapes":
        from reco.datasets.cityscapes import CityscapesDataset, cityscapes_categories, cityscapes_pallete
        ...
        from reco.datasets.coco_stuff import COCOStuffDataset, coco_stuff_pallete, coco_stuff_categories_fine
        ...
        from reco.datasets.pascal_context import pascal_context_categories, PascalContextDataset, pascal_context_pallete
        ...
        from reco.datasets.kitti_step import KittiStepDataset, kitti_step_categories, kitti_step_palette
